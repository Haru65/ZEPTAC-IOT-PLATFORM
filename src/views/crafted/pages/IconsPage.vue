<template>
    <div class="container mt-4">
        <div class="row justify-content-center fs-6">
          <h1>Icons</h1>  
          <div :style="{ color: getRandomColor() }" v-for="(value, key, index) in data" :key="key" class="rounded border w-500px h-auto p-2 gap-2 m-2 col-3 col-sm-4 col-md-3 col-lg-2 d-flex justify-content-center">
...
export default {
  name: "icons-page",
  setup() {
    const colors = ["gray", "skyblue", "orange", "red", "green"];

    // Function to randomly pick one color from the array
