            ...
            <div class="row mb-6">
              ...
              <div class="col-md-6 fv-row mb-8 mb-sd-8">
                ...
                <el-date-picker
                  ...
                  name="replicate_date"
                  id="replicate_date"
                  v-model="itemDetails.replicate_date"
                  @change="setDates($event, 'replicate_date')"
                  placeholder="Pick a day"
                  :editable="false"
                />
                <div
                  class="fv-plugins-message-container mt-3"
                  v-if="!itemDetails.replicate_date"
                >
                  <div class="fv-help-block">
                    <ErrorMessage name="replicate_date" />
                  </div>
                </div>
                <!--end::Input-->
              </div>
            ...
            <div class="row mb-6">
              <div class="form-group col-md-6">
                ...
                <Field
                  ...
                  v-model="itemDetails.engineer_1"
                />
                <div class="fv-plugins-message-container">
                  <div class="fv-help-block">
                    <ErrorMessage name="engineer_1" />
                  </div>
                </div>
              </div>
              <div class="form-group col-md-6">
                ...
                <Field
                  ...
                  class="form-control form-control-lg form-control-solid"
                  placeholder="Enter Engineer Name"
                  v-model="itemDetails.engineer_2"
                />
                <div class="fv-plugins-message-container">
                  <div class="fv-help-block">
                    <ErrorMessage name="engineer_2" />
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div class="row mb-6">
                      <div class="form-group col-lg-12">
                        ...
                        <Field
                          ...
                          v-model="itemDetails.uuc_details.name"
                        />
                        <div class="fv-plugins-message-container">
                          <div class="fv-help-block">
                            <ErrorMessage name="uuc_name" />
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="accordion-body">
                    ...
                    <div class="row mb-6">
                      <div class="form-group col-lg-12">
                        ...
                        <Field
                          type="text"
                          name="master_equipment_1_name"
                          class="form-control form-control-lg form-control-solid"
                          placeholder="Instrument name"
                          v-model="itemDetails.master_equipment_1.name"
                        />
                        <div class="fv-plugins-message-container">
                          <div class="fv-help-block">
                            <ErrorMessage name="master_equipment_1_name" />
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      >
                        <thead>
                          ...
                          >
                            ...
                            <th class="col-3">Readding of Engineer 1</th>
                            <th class="col-3">Readding of Engineer 2</th>
                            <th class="col-3">Tolerance of UUC</th>
                            <th class="col-3">Remarks Criteria</th>
                        ...
                        <tbody>
                          <tr
                            v-for="(
                              reading, index
                            ) in itemDetails.replicate_report_readings"
                            :key="index"
                          >
                            <td>
                              <span
                            ...
                            <td>
                              <input
                                type="text"
                                name="reading_engineer_1"
                                class="form-control form-control-lg form-control-solid"
                                placeholder="reading"
                                v-model="reading.reading_engineer_1"
                              />
                            </td>
                            <td>
                              <input
                                type="text"
                                name="reading_engineer_2"
                                class="form-control form-control-lg form-control-solid"
                                placeholder="reading"
                                v-model="reading.reading_engineer_2"
                              />
                            </td>
                            <td>
                              <input
                                ...
                                name="uuc_tolerance"
                                class="form-control form-control-lg form-control-solid"
                                placeholder="Tolerance of UUC"
                                v-model="reading.uuc_tolerance"
                              />
                            </td>
                            <td>
                              <input
...
import { getReplicateReport, updateReplicateReport } from "@/stores/api";
...
export default defineComponent({
  ...
  setup() {
    ...
    const itemDetails = ref({
      ...
      replicate_report_readings: reactive([
        {
          parameter: "",
          reading_engineer_1: "",
          reading_engineer_2: "",
    ...
    const addReading = () => {
      itemDetails.value.replicate_report_readings.push({
        parameter: "",
        reading_engineer_1: "",
        reading_engineer_2: "",
        uuc_tolerance: "",
    ...
    const removeReading = (index) => {
      itemDetails.value.replicate_report_readings.splice(index, 1);
    };
    ...
    const submit = async () => {
      ...
      if (itemDetails.value.replicate_report_readings.length === 0) {
      ...
      try {
        if (validateForm(itemDetails.value)) {
          const response = await updateReplicateReport(
            itemId,
            itemDetails.value
          );
          if (response.success) {
