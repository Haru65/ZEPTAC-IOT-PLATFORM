        ...
        >
          ...
          <template v-slot:method_validation="{ row: validation_method }">
            <span
              ...
              >{{ GetValidationMethod(validation_method.method_validation) }}</span
            >
          </template>
          ...
          <template v-slot:actions="{ row: validation_method }">
            ...
            <div class="d-flex flex-lg-row">
              <span class="menu-link px-3">
                <router-link :to="`/method_validation/edit/${validation_method.id}`">
                  <i
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      async function SearchMore() {
        ...
        try {
          const response = await MethodValidationSearch(search.value);
