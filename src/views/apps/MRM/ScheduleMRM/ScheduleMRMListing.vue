  ...
  <div class="card">
    <div class="card-header border-0 pt-6">
      ...
      <div class="card-toolbar">
        ...
        >
          ...
          <!--end::Export-->
          <!--begin::Add customer-->
          <router-link to="/mrm_schedule/add" class="btn btn-primary">
    ...
    <div class="card-body pt-0">
      ...
      >
        ...
        <template v-slot:id="{ row: mrm }">
          {{ mrm.id }}
        </template>
        <template v-slot:agenda="{ row: mrm }">
          {{ mrm.agenda }}
        </template>
        <template v-slot:meeting_date="{ row: mrm }">
        ...
        <template v-slot:approval_status="{ row: mrm }">
          <!-- Status Badge Only -->
          <span
            class="badge py-3 px-4 fs-7"
            :class="{
              'badge-light-primary': mrm.approval_status == 1,
              'badge-light-danger': mrm.approval_status == 2,
              'badge-light-success': mrm.approval_status == 3,
            }"
          >
            {{ GetApprovalStatus(mrm.approval_status) }}
          </span>
        </template>
        ...
        <template v-slot:actions="{ row: mrm }">
          ...
          <div class="dropdown">
            ...
            <template
              ...
              <!-- Edit / View MRM Schedule -->
              <li>
                <router-link
                  :to="`/mrm_schedule/edit/${mrm.id}`"
              ...
              <li>
                <a
                  ...
                  @click.prevent="deleteItem(mrm.id, false)"
                >
...
export default defineComponent({
  ...
  setup() {
    ...
    const tableData = ref<Array<IMRM>>([]);

    const initvalues = ref<Array<IMRM>>([]);
