            ...
            <div class="row mb-6" v-if="itemDetails.manual_available == 1">
              ...
              <div class="col-lg-9">
                ...
                <div class="row">
                  ...
                  <div
                    v-else-if="itemDetails.manual_file != ''"
  ...
  setup() {
    ...
    const submit = async () => {
      ...
      try {
        ...
        // Call your API here
        const response = await addReferenceInstrument(itemDetails.value);
