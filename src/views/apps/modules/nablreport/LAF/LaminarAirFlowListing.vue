<template>
  ...
  import { deleteLaminarAirFlow, getLaminarAirFlows, LaminarAirFlowSearch } from "@/stores/api";
    ...
    setup() {
      ...
      const PagePointer = async (page) => {
        ...
        try {
          ...
          const response = await getLaminarAirFlows(`page=${page}&limit=${limit.value}`);
      ...
      const PageLimitPoiner = async (limit) => {
        ...
        try {
          ...
          const response = await getLaminarAirFlows(`page=${page.value}&limit=${limit}`);
