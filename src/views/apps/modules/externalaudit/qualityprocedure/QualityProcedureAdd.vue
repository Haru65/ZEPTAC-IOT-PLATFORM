            ...
            <div class="row mb-6">
              ...
              <div class="col-lg-9">
                ...
                <div class="row">
                  ...
                  <div
                    v-else-if="procedureDetails.audit_document != ''"
...
import { addQualityProcedure, removeImage, uploadImage } from "@/stores/api";
  ...
  setup() {
    ...
    const submit = async () => {
      ...
      try {
        ...
        if (result) {
          const response = await addQualityProcedure(procedureDetails.value);
