                ...
                <div class="row mb-6">
                  ...
                  <div class="col-md-12 fv-row">
                    ...
                    <Field
                      ...
                      as="textarea"
                      rows="2"
                      v-model="itemDetails.data.training_topic"
                      name="training_topic"
        ...
        <div class="card mb-5 mb-xl-10 pb-12">
          <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
              <!--begin::Card title-->
              <div class="card-title m-0">
                <h3 class="fw-bold m-0">Training Plan List</h3>
              </div>
              <!--end::Card title-->
            </div>
            <!--begin::Card title-->
          ...
          <div class="card-body pt-0">
            <div class="table-responsive">
              ...
              >
                ...
                <template v-slot:data="{ row: planner }">
                  {{ planner.data.training_topic }}
                </template>
      ...
      try {
        if (validateForm(itemDetails)) {
          ...
          if (response?.success) {
            ...
            showSuccessAlert(
              "Success",
              response.message || "Training Plan has been successfully added!"
            );
