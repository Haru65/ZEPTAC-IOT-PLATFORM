          ...
          <div class="card mb-5 mb-xl-10 p-6 pb-12">
            ...
            <div class="card-header border-0 cursor-pointer">
              ...
              <div class="card-title m-0">
                <h3 class="fw-bold m-0">Add InterLaboratory Comparison Plan</h3>
              </div>
              <div
              ...
              <div class="card-body p-9">
                <div class="row mb-6">
                  ...
                  <div class="col-md-12 fv-row">
                    ...
                    <Field
                      type="text"
                      v-model="itemDetails.data.parameter"
                      name="parameter"
            ...
            <div class="card-title">
              ...
              <div class="card-title m-0">
                <h3 class="fw-bold m-0">
                  InterLaboratory Comparison Plan List
                </h3>
              </div>
              <!--end::Card title-->
            </div>
          ...
          <div class="card-body pt-0">
            <div class="table-responsive">
              ...
              >
                ...
                <template v-slot:parameter="{ row: planner }">
                  {{ planner.data.parameter }}
                </template>
