          ...
          <div class="card mb-5 mb-xl-10 p-6 pb-12">
            ...
            <div class="card-header border-0 cursor-pointer">
              ...
              <div class="card-title m-0">
                <h3 class="fw-bold m-0">Add Maintenance Plan</h3>
              </div>
              <div
              ...
              <div class="card-body p-9">
                  ...
                  <div class="col-md-6 fv-row mb-8 mb-sd-8">
                    ...
                    <div>
                      <el-select
                        ...
                        name="id"
                        v-model="itemDetails.data.id"
                        v-on:change="setInstrument"
                      >
                        <el-option
                          value=""
                          disabled="disabled"
                ...
                <div class="row mb-6">
                  <div class="form-group col-md-6">
                    ...
                    >
                      {{ itemDetails.data.instrument_id }}
                    </div>
                  </div>
                ...
                <div class="row mb-6">
                  ...
                  <div class="col-md-12 fv-row">
                    ...
                    <Field
                      ...
                      as="textarea"
                      rows="5"
                      v-model="itemDetails.data.maintenance_details"
                    ...
                    <div class="fv-plugins-message-container">
                      <div class="fv-help-block">
                        <ErrorMessage name="maintenance_details" />
                      </div>
                    </div>
                    <!--end::Input-->
                  </div>
        ...
        <div class="card mb-5 mb-xl-10 pb-12">
          <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
              <!--begin::Card title-->
              <div class="card-title m-0">
                <h3 class="fw-bold m-0">Maintenance Plan List</h3>
              </div>
              <!--end::Card title-->
            </div>
            <!--begin::Card title-->
          ...
          <div class="card-body pt-0">
            <div class="table-responsive">
              ...
              >
                ...
                <template v-slot:instrument_id="{ row: planner }">
                  {{ planner.data.instrument_id }}
                </template>
                <template v-slot:name="{ row: planner }">
                  {{ planner.data.name }}
                </template>
                <template v-slot:maintenance_details="{ row: planner }">
                  {{ planner.data.maintenance_details }}
                </template>
...
export default defineComponent({
  ...
  setup() {
    ...
    const tableHeader = ref([
      ...
      {
        columnName: "Maintenance Details",
        columnLabel: "maintenance_details",
        sortEnabled: true,
        columnWidth: 200,
      },
      {
    ...
    const itemValidator = Yup.object().shape({
      training_topic: Yup.string().required().label("Topic Name"),
    });
    ...
    const getdropinstrument = async () => {
      try {
        ApiService.setHeader();
        const response = await getCalibratedInstruments(User.company_id);
        ...
        if (response.success) {
          ...
          console.error(
            `Error Occured in getCalibratedInstruments : ${
              response.message || "Error Occured in API"
            }`
          );
        }
      } catch (err) {
        console.error(`Error Occured in getCalibratedInstruments : ${err}`);
      }
    };

    const setInstrument = (id) => {
      if (id) {
        const foundInstrument = Instruments.value.find(
          (instrument) => id === instrument.id
        );
        if (foundInstrument) {
          itemDetails.value.data.id = foundInstrument.id;
          itemDetails.value.data.instrument_id = foundInstrument.instrument_id;
          itemDetails.value.data.name = foundInstrument.name;
          itemDetails.value.data.make = foundInstrument.make;
          itemDetails.value.data.model_no = foundInstrument.model_no;
          itemDetails.value.data.serial_no = foundInstrument.serial_no;
        }
      } else {
        itemDetails.value.data.id = "";
        itemDetails.value.data.instrument_id = "";
        itemDetails.value.data.name = "";
        itemDetails.value.data.make = "";
        itemDetails.value.data.model_no = "";
        itemDetails.value.data.serial_no = "";
      }
    };
        ...
        if (validateForm(itemDetails)) {
          ...
          if (response?.success) {
            ...
            showSuccessAlert(
              "Success",
              response.message ||
                "Maintenance Plan has been successfully added!"
            );
