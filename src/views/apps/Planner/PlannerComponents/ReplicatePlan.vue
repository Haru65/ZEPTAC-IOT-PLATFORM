          ...
          <div class="card mb-5 mb-xl-10 p-6 pb-12">
            ...
            <div class="card-header border-0 cursor-pointer">
              ...
              <div class="card-title m-0">
                <h3 class="fw-bold m-0">Add Replicate Plan</h3>
              </div>
              <div
              ...
              <div class="card-body p-9">
                <div class="row mb-6">
                  ...
                  <div class="col-md-12 fv-row">
                    ...
                    <label
                      ...
                      >Description of Equipment</label
                    >
                    <!--end::Label-->
                    ...
                    <Field
                      ...
                      as="textarea"
                      rows="3"
                      v-model="itemDetails.data.description"
                      name="description"
                      class="form-control form-control-lg form-control-solid"
                      placeholder="Enter description of equipment..."
                    />
                ...
                <div class="row mb-6">
                  ...
                  <div class="col-md-12 fv-row">
                    ...
                    <Field
                      type="text"
                      v-model="itemDetails.data.reference_standard"
        ...
        <div class="card mb-5 mb-xl-10 pb-12">
          <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
              <!--begin::Card title-->
              <div class="card-title m-0">
                <h3 class="fw-bold m-0">Replicate Plan List</h3>
              </div>
              <!--end::Card title-->
            </div>
            <!--begin::Card title-->
          ...
          <div class="card-body pt-0">
            <div class="table-responsive">
              ...
              >
                ...
                <template v-slot:description="{ row: planner }">
                  {{ planner.data.description }}
                </template>
                <template v-slot:reference_standard="{ row: planner }">
                  {{ planner.data.reference_standard }}
                </template>
...
export default defineComponent({
  ...
  setup() {
    ...
    const tableHeader = ref([
      ...
      {
        columnName: "Description of Equipment",
        columnLabel: "description",
        sortEnabled: true,
        columnWidth: 200,
      },
      {
        columnName: "Reference Standard",
        columnLabel: "reference_standard",
        sortEnabled: true,
        columnWidth: 100,
      },
      {
      ...
      try {
        if (validateForm(itemDetails)) {
          ...
          if (response?.success) {
            ...
            showSuccessAlert(
              "Success",
              response.message || "Replicate Plan has been successfully added!"
            );
