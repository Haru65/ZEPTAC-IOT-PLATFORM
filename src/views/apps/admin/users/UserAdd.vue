          ...
          <div class="row mb-6">
            ...
            <div class="col-lg-8">
              ...
              >
                ...
                <img
                  v-if="profileDetails.profile_pic"
                  v-bind:src="`https://api.zeptac.com/storage/temporary/${profileDetails.profile_pic}`"
          ...
          <div class="row mb-6">
            ...
            <div class="col-lg-8">
              ...
              <div class="row">
                ...
                <div
                  v-else-if="profileDetails.adhar != ''"
...
import { addUser, getCompanies, removeImage, uploadImage } from "@/stores/api";
      ...
      try {
        ...
        if (validateForm(profileDetails.value)) {
          ...
          if (response.success) {
            ...
            showSuccessAlert("Success", response.message || "User have been successfully added!");
