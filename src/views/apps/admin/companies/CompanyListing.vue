...
import type { ICompany } from "@/core/apis/company";
import company from "@/core/apis/company";
...
export default defineComponent({
  ...
  setup() {
    ...
    const tableData = ref<Array<ICompany>>(company);
    const initCustomers = ref<Array<ICompany>>([]);
