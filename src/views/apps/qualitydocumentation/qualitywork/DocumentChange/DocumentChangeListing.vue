      ...
      >
        ...
        <template v-slot:approval_status="{ row: document_change }">
          ...
          <span
            ...
            :class="{
              'badge-light-primary': document_change.approval_status == 1,
              'badge-light-danger': document_change.approval_status == 2,
              'badge-light-success': document_change.approval_status == 3,
            }"
          >
            {{ GetApprovalStatus(document_change.approval_status) }}
          </span>
        </template>
