                        ...
                        >
                          <thead>
                            ...
                            >
                              ...
                              <th class="col-5">Clause Details</th>
                              <th class="col-5">NC Observations</th>
                              <th class="col-2">Evidence</th>
                              <th>Action</th>
                            </tr>
                          </thead>
                          <tbody>
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(async () => {
      ...
      let response = await getIAuditObservation(itemId.toString());
      console.log(response);
      auditObservationDetails.value = {
        auditor_name: response.auditor_name,
        clause_name: response.clause_name,
    ...
    const submit = async () => {
      ...
      try {
        ...
        const response = await updateIAuditObservation(itemId, 
          auditObservationDetails.value
        );
        ...
        if (!response.error) {
          ...
          showSuccessAlert(
            "Success",
            "Internal Audit Observation has been successfully updated!"
          );
