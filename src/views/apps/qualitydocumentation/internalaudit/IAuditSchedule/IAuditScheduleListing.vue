      ...
      >
        ...
        <template v-slot:approval_status="{ row: audit_schedule }">
          ...
          <span
            ...
            :class="{
              'badge-light-primary': audit_schedule.approval_status == 1,
              'badge-light-danger': audit_schedule.approval_status == 2,
              'badge-light-success': audit_schedule.approval_status == 3,
            }"
          >
            {{ GetApprovalStatus(audit_schedule.approval_status) }}
          </span>
        </template>
