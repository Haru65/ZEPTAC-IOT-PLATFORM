...
import { getTempHumidityDataByPeriod } from "@/core/data/chartData";
...
export default defineComponent({
  ...
  setup() {
    ...
    const chartData = computed(() =>
      getTempHumidityDataByPeriod(timePeriod.value)
    );
    ...
    const chartOptions = computed<ApexOptions>(() => {
      ...
      const tempColor = getCSSVariableValue("--bs-primary");
      const humidColor = getCSSVariableValue("--bs-info");
