          ...
          <div class="row mb-6">
            <div class="form-group col-md-12">
              ...
              <Field
                ...
                placeholder="Specify the reason of rejection if any..."
                v-model="itemData.comment_description"
              />
            </div>
          </div>
          <!--end::Input group-->
...
import { PurchaseOrderStatus } from "@/stores/api";
  ...
  setup(props, { emit }) {
    ...
    const updateApprovalStatus = async () => {
      ...
      try {
        ...
        const response = await PurchaseOrderStatus(
          itemData.value.id,
          itemData.value
        );
