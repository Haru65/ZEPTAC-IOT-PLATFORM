                      ...
                      >
                        <thead>
                          ...
                          >
                            ...
                            <th class="col-5">Installation Date</th>
                            <th>Edit</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr
                            v-for="(
                              plan, index
                            ) in itemDetails?.inspection_records"
                            :key="index"
                          >
                          ...
                          <tr
                            class="text-center"
                            v-if="itemDetails.inspection_records == null ||
                              itemDetails.inspection_records?.length ===
                              0
                            "
                          >
                            <td
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      onMounted(async () => {
        ...
        itemDetails.value.inspection_records =  response.result?.inspection_records ? response.result?.inspection_records : [];
