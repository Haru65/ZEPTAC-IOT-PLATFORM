          ...
          <div id="kt_customer_view_details" class="collapse show">
            <div class="py-5 fs-6">
              ...
              <div class="text-gray-600">
                <a href="#" class="text-gray-600 text-hover-primary">info@portal.com</a>
              </div>
              <!--begin::Details item-->
              <!--begin::Details item-->
      ...
      <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-body pt-2">
          <div class="notice d-flex bg-light-primary rounded border-primary border border-dashed mb-9 p-6">
            <KTIcon icon-name="design-frame" icon-class="fs-2tx text-primary me-4" />
            <!--begin::Wrapper-->
          ...
          <div class="py-2">
            ...
            <div class="d-flex flex-stack">
              <div class="d-flex">
                <img :src="getAssetPath('media/svg/brand-logos/google-icon.svg')" class="w-30px me-6" alt="" />
              ...
              <div class="d-flex justify-content-end">
                ...
                <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid">
                  ...
                  <input class="form-check-input" name="google" type="checkbox" value="1"
                    id="kt_modal_connected_accounts_google" checked />
                  <!--end::Input-->

                  <!--begin::Label-->
                  <span class="form-check-label fw-semobold text-muted" for="kt_modal_connected_accounts_google"></span>
                  <!--end::Label-->
                </label>
                <!--end::Switch-->
              </div>
            ...
            <div class="d-flex flex-stack">
              <div class="d-flex">
                <img :src="getAssetPath('media/svg/brand-logos/github.svg')" class="w-30px me-6" alt="" />
              ...
              <div class="d-flex justify-content-end">
                ...
                <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid">
                  ...
                  <input class="form-check-input" name="github" type="checkbox" value="1"
                    id="kt_modal_connected_accounts_github" checked />
                  <!--end::Input-->

                  <!--begin::Label-->
                  <span class="form-check-label fw-semobold text-muted" for="kt_modal_connected_accounts_github"></span>
                  <!--end::Label-->
                </label>
                <!--end::Switch-->
              </div>
            ...
            <div class="d-flex flex-stack">
              <div class="d-flex">
                <img :src="getAssetPath('media/svg/brand-logos/slack-icon.svg')" class="w-30px me-6" alt="" />
              ...
              <div class="d-flex justify-content-end">
                ...
                <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid">
                  ...
                  <!--begin::Label-->
                  <span class="form-check-label fw-semobold text-muted" for="kt_modal_connected_accounts_slack"></span>
                  <!--end::Label-->
                </label>
                <!--end::Switch-->
              </div>
