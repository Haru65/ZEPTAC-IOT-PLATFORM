<template>
  ...
  <div
    ...
    :id="'kt_modal_new_address_' + $props.leadId"
    tabindex="-1"
    aria-hidden="true"
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    async function resetTheData() {
      leadDetails.value = await { ...props.leadInfo };
    }
    ...
    const submit = async () => {
      ...
      try {
        ...
        await emit("editData", props.leadId, leadDetails.value);
        showSuccessAlert("Success", "Lead Updated Successfully!");
        hideModal(newAddressModalRef.value);
      } catch (error) {
        // Handle any other errors during API call
        console.error("API call error:", error);
        showErrorAlert("Error", "Failed to update data. Try again later.");
      } finally {
        if (submitButtonRef.value) {
