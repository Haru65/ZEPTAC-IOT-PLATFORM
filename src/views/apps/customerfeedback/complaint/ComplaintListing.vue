      ...
      >
        ...
        <template v-slot:approval_status="{ row: complaints }">
          ...
          <span
            ...
            :class="{
              'badge-light-primary': complaints.approval_status == 1,
              'badge-light-danger': complaints.approval_status == 2,
              'badge-light-success': complaints.approval_status == 3,
            }"
          >
            {{ GetApprovalStatus(complaints.approval_status) }}
          </span>
        </template>
        ...
        <template v-slot:actions="{ row: complaints }">
          ...
          <div class="dropdown">
            ...
            >
              ...
              <li>
                <router-link
                  :to="`/complaint/edit/${complaints.id}`"
              ...
              <li>
                <a
                  ...
                  @click.prevent="deleteItem(complaints.id, false)"
                >
...
export default defineComponent({
  ...
  setup() {
    ...
    async function SearchMore() {
      ...
      try {
        const response = await ComplaintSearch(
          search.value,
          selectedYearCache.value
            ? selectedYearCache.value
            : financialYears.value[0]
