            ...
            >
              ...
              <li>
                <a
                  ...
                  @click.prevent="downloadReport(thermal_reports.id)"
                >
                  <KTIcon
                    icon-name="file-down"
              ...
              <li>
                <router-link
                  :to="`/thermalreport/edit/${thermal_reports.id}`"
              ...
              <li>
                <a
                  ...
                  @click.prevent="deleteItem(thermal_reports.id, false)"
                >
  ...
  setup() {
    ...
    const deleteItem = async (id: number, mul: boolean) => {
      ...
      const deleteFromTable = async (id: number) => {
        try {
          const response = await deleteThermalReport(id);
          if (response?.success) {
