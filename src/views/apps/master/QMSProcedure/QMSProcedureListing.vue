      ...
      >
        ...
        <template v-slot:approval_status="{ row: qms }">
          <span
            ...
            :class="{
              'badge-light-primary': qms.approval_status == 1,
              'badge-light-danger': qms.approval_status == 2,
              'badge-light-success': qms.approval_status == 3,
            }"
          >
            {{ GetApprovalStatus(qms.approval_status) }}
          </span>
        </template>
