    ...
    <div class="card-body pt-0">
      ...
      >
        ...
        <template v-slot:approval_status="{ row: ni }">
          <span
            v-if="ni.approval_status == 1"
            class="badge py-3 px-4 fs-7 badge-light-primary"
            >{{ GetApprovalStatus(ni.approval_status) }}</span
          >
          <span
            v-if="ni.approval_status == 2"
            class="badge py-3 px-4 fs-7 badge-light-danger"
            >{{ GetApprovalStatus(ni.approval_status) }}</span
          >
          <span
            v-if="ni.approval_status == 3"
            class="badge py-3 px-4 fs-7 badge-light-success"
            >{{ GetApprovalStatus(ni.approval_status) }}</span
          >
        </template>

        <template v-slot:approval_button="{ row: ni }">
          <button
            type="button"
