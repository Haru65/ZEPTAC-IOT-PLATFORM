              ...
              >
                ...
                <div class="mb-3 mb-md-0 fw-semobold">
                  <h4 class="text-gray-800 fw-bold cursor-pointer">
                    <a
                      target="blank"
                      v-bind:href="`https://api.zeptac.com/storage/company/${documentDetails.company_id}/national_international_documents/${documentDetails.document_file}`"
                      data-toggle="tooltip"
                      title="preview file"
                      class="underline"
...
import { getNIDoc, updateNIDoc, removeImage, uploadImage } from "@/stores/api";
      ...
      try {
        ...
        if (response?.success) {
          ...
          showSuccessAlert(
            "Success",
            response.message ||
              "National-International has been successfully Updated!"
          );
