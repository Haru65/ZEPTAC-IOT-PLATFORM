<template>
        ...
        <div class="modal-content">
          ...
          >
            ...
            <div class="modal-header" id="kt_modal_new_address_header">
              <!--begin::Modal title-->
              <h2>Add National-International Document</h2>
              <!--end::Modal title-->
  ...
  import { addNIDoc } from "@/stores/api";
      ...
      const submit = async (e) => {
        ...
        if (!result) {
          try {
            ...
            const response = await addNIDoc(documentDetails.value);
            ...
            if (!response.error) {
              ...
              showSuccessAlert("Success", "National-International Document Added Successfully!");
              clear();
