      ...
      >
        ...
        <template v-slot:actions="{ row: record }">
          ...
          <div class="d-flex flex-lg-row">
            ...
            <span class="menu-link px-3">
              <i
                @click="deleteDocument(record.id, false)"
  ...
  setup() {
    ...
    const PagePointer = async (page) => {
      ...
      try {
        ...
        const response = await getRecords(`page=${page}&limit=${limit.value}`);
    ...
    const PageLimitPoiner = async (limit) => {
      ...
      try {
        ...
        const response = await getRecords(`page=${page.value}&limit=${limit}`);
    ...
    async function SearchMore() {
      ...
      try {
        const response = await RecordSearch(search.value);
