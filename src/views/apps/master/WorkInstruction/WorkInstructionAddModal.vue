...
import { addWorkInstruction, removeImage, uploadImage } from "@/stores/api";
  ...
  setup(props, { emit }) {
    ...
    const submit = async (e) => {
      ...
      try {
        ...
        // Call your API here
        const response = await addWorkInstruction(documentDetails.value);
        ...
        if (response?.success) {
          ...
          showSuccessAlert(
            "Success",
            response.message || "Work Instruction Added Successfully!"
          );
          clear();
