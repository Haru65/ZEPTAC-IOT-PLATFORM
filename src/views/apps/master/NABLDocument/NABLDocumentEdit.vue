              ...
              >
                ...
                <div class="mb-3 mb-md-0 fw-semobold">
                  <h4 class="text-gray-800 fw-bold cursor-pointer">
                    <a
                      target="blank"
                      v-bind:href="`https://api.zeptac.com/storage/company/${documentDetails.company_id}/nabl/${documentDetails.document_file}`"
                      v-tooltip
                      title="preview file"
                      class="underline"
  ...
  setup() {
    ...
    const submit = async () => {
      ...
      try {
        ...
        // Call your API here
        const response = await updateNABLDoc(itemId, documentDetails.value);
