        ...
        >
          ...
          <template v-slot:document_file="{ row: nabl }">
            ...
            <div class="d-flex flex-lg-row">
              <a
                target="blank"
                v-bind:href="`http://localhost:8000/storage/company/${nabl.company_id}/nabl/${nabl.document_file}`"
                data-toggle="tooltip"
                title="Download File"
          ...
          <template v-slot:actions="{ row: nabl }">
            ...
            <div class="d-flex flex-lg-row">
              ...
              <span class="menu-link px-3">
                <i
                  @click="deleteDocument(nabl.id, false)"
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      async function SearchMore() {
        ...
        try {
          const response = await NABLDocSearch(search.value);
