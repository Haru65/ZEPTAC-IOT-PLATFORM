...
const Gen = async (
    ...
    const uniqueNumber = (pdftype == "quotation" ? invoiceDetials.value.quotation_no : invoiceDetials.value.invoice_no)
      ...
      const LocationData = [
        [
          `Customer Name : ${invoiceDetials.value.customer.first_name} ${invoiceDetials.value.customer.last_name} \nCompany Name : ${invoiceDetials.value.customer.company_name}\n\nBilling Address : ${invoiceDetials.value.customer.address1 ? invoiceDetials.value.customer.address1 : ""} ${invoiceDetials.value.customer.address2 ? invoiceDetials.value.customer.address2 : ""} ${invoiceDetials.value.customer.city ? invoiceDetials.value.customer.city : ""} - ${invoiceDetials.value.customer.pincode ? invoiceDetials.value.customer.pincode : ""}, ${invoiceDetials.value.customer.states ? invoiceDetials.value.customer.states : ""}, ${invoiceDetials.value.customer.country ? invoiceDetials.value.customer.country : ""}`,
          `Client Name : ${invoiceDetials.value.client.first_name} ${invoiceDetials.value.client.last_name} \nCompany Name : ${invoiceDetials.value.client.company_name}\n\nSite Address : ${invoiceDetials.value.client.address1 ? invoiceDetials.value.client.address1 : ""} ${invoiceDetials.value.client.address2 ? invoiceDetials.value.client.address2 : ""} ${invoiceDetials.value.client.city ? invoiceDetials.value.client.city : ""} - ${invoiceDetials.value.client.pincode ? invoiceDetials.value.client.pincode : ""}, ${invoiceDetials.value.client.states ? invoiceDetials.value.client.states : ""}, ${invoiceDetials.value.client.country ? invoiceDetials.value.client.country : ""}`
        ]
      ];
