<template>
  ...
  <div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
    ...
    <router-link to="/">
      ...
      " alt="Logo" :src="getAssetPath('media/logos/zeptac_color_noname.png')"
        class="h-25px app-sidebar-logo-default" />
      <img v-if="themeMode === 'light' && layout === 'light-sidebar'" alt="Logo"
        :src="getAssetPath('media/logos/zeptac_color_noname.png')" class="h-25px app-sidebar-logo-default" />
      <img alt="Logo" :src="getAssetPath('media/logos/zeptac_color.png')" class="h-20px app-sidebar-logo-minimize" />
    </router-link>
    <!--end::Logo image-->
