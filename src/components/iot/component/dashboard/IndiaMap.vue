        ...
        series: [
          {
            ...
            data: [
              { name: "Mumbai", value: [72.8777, 19.076, 10] },
              { name: "Delhi", value: [77.1025, 28.7041, 7] },
              { name: "Hyderabad", value: [78.4867, 17.385, 5] },
              { name: "Chennai", value: [80.2707, 13.0827, 3] },
              { name: "Bengaluru", value: [77.5946, 12.9716, 8] },
            ],
          },
        ],
      };
